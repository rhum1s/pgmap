...
class PgMap():
    ...
    def map(self, sql, geom_field="geom"):
        ...
        bbox = calculate_bbox(geo_dataframe)  # Extent in WGS 84
        ...
        # map.shadedrelief(zorder=0, alpha=0.2)  # TODO: Doesn't seems to work!!
...
pm = PgMap("config.cfg")
pm.map("select * from bdcarthage.point_eau_isole limit 500;", "the_geom")
